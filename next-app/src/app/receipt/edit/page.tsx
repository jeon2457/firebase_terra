                            ...
                            <div key={img._id} className="col-12">
                                <div className="edit-card p-3 d-flex flex-column flex-md-row gap-3 align-items-center">
                                    ...
                                    <div className="flex-fill w-100">
                                        <div className="small text-muted mb-1">{img.date}</div>
                                        <textarea
                                    ...
                                    <div className="d-flex flex-md-column gap-2">
                                        <button className="btn btn-success btn-sm px-3" onClick={() => handleUpdateNotice(img._id)}>
                                            <Save size={14} className="me-1" /> 저장
                                        </button>
                                        <button className="btn btn-danger btn-sm px-3" onClick={() => handleDelete(img._id, img.public_id)}>
