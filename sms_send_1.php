<?php
// obituary_sms.php : 부고장 문자 발송 페이지
...
<body>
  ...
  <div class="main-container">
    ...
    <form id="smsForm">
      ...
      <!-- 2. 문자 내용 입력 -->
      <div class="card">
        <div class="card-header">문자 내용 (부고 알림)</div>
        <textarea id="smsMessage" class="form-control">🌼[부고 알림]
...
유족에게 큰 힘이 될 것입니다.
    ...
    <div class="button-section">
      ...
      <div class="action-buttons">
        <button type="button" class="btn btn-dark" onclick="sendSMS()">📩 문자 보내기</button>
