...
<body>
  ...
  <div class="main-container">
    ...
    <div class="btn-grid">
      ...
      <div class="btn-card">
        <button class="btn" onclick="location.href='account_input_1.php'">
          거래명세서 입력
        </button>
      </div>

      <div class="btn-card">
        <button class="btn" onclick="location.href='account_edit_1.php'">
          거래명세서 편집
        </button>
      </div>

      <div class="btn-card">
        <button class="btn" onclick="location.href='account_view_1.php'">
          거래명세서 보기
        </button>
      </div>
    ...
    <!-- 되돌아가기 -->
    <a href="select_menu_3.php" class="btn-back">⏪ 돌아가기</a>
