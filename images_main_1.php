...
<body>
  ...
  <div class="main-wrapper">
    ...
    <div class="btn-grid">
      ...
      <div class="btn-card">
        <button class="btn" onclick="location.href='images_upload_1.php'">
          영수증사진 업로드
        </button>
      </div>

      <div class="btn-card">
        <button class="btn" onclick="location.href='images_edit_1.php'">
          영수증사진 편집
        </button>
      </div>

      <div class="btn-card">
        <button class="btn" onclick="location.href='images_view_1.php'">
          영수증사진 보기
        </button>
      </div>
